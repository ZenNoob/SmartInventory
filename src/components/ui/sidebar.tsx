  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-dvh transition-[width] ease-linear md:flex",
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 p-3 overflow-auto group-data-[sidebar-state=collapsed]:items-center",
        className
      )}
      {...props}
    />
